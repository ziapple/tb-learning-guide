...
public abstract class AbstractTransportService implements TransportService {
    ...
    private ConcurrentMap<Long, TbRateLimits> perTenantLimits = new ConcurrentHashMap<>();
    private ConcurrentMap<Long, TbRateLimits> perDeviceLimits = new ConcurrentHashMap<>();
    ...
    public boolean checkLimits(TransportProtos.SessionInfoProto sessionInfo, Object msg, TransportServiceCallback<Void> callback) {
        ...
        Long tenantId = sessionInfo.getTenantIdMSB();
        ...
        Long deviceId = sessionInfo.getDeviceIdMSB();
