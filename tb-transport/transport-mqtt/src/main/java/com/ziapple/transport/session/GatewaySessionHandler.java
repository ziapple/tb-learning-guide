 ...
 */
package com.ziapple.transport.session;
...
import com.ziapple.transport.MqttTransportContext;
import com.ziapple.transport.MqttTransportHandler;
import com.ziapple.transport.TransportProtos;
import com.ziapple.transport.TransportProtos.DeviceInfoProto;
import com.ziapple.transport.TransportProtos.GetOrCreateDeviceFromGatewayRequestMsg;
import com.ziapple.transport.TransportProtos.GetOrCreateDeviceFromGatewayResponseMsg;
import com.ziapple.transport.TransportProtos.SessionInfoProto;
import com.ziapple.transport.adaptors.JsonMqttAdaptor;
...
import com.ziapple.transport.api.adaptor.JsonConverter;
...
public class GatewaySessionHandler {
    ...
    public void onDeviceConnect(MqttPublishMessage msg) throws adaptor.AdaptorException {
    ...
    public void onDeviceDisconnect(MqttPublishMessage msg) throws adaptor.AdaptorException {
    ...
    public void onDeviceTelemetry(MqttPublishMessage mqttMsg) throws adaptor.AdaptorException {
    ...
    public void onDeviceClaim(MqttPublishMessage mqttMsg) throws adaptor.AdaptorException {
        JsonElement json = JsonMqttAdaptor.validateJsonPayload(sessionId, mqttMsg.payload());
        int msgId = mqttMsg.variableHeader().packetId();
        if (json.isJsonObject()) {
            JsonObject jsonObj = json.getAsJsonObject();
                ...
                Futures.addCallback(checkDeviceConnected(deviceName),
                        new FutureCallback<GatewayDeviceSessionCtx>() {
                            ...
                            public void onSuccess(@Nullable GatewayDeviceSessionCtx deviceCtx) {
                                ...
                                try {
                                    Long deviceId = deviceCtx.getDeviceId();
    ...
    public void onDeviceAttributes(MqttPublishMessage mqttMsg) throws adaptor.AdaptorException {
        JsonElement json = JsonMqttAdaptor.validateJsonPayload(sessionId, mqttMsg.payload());
        int msgId = mqttMsg.variableHeader().packetId();
        if (json.isJsonObject()) {
            JsonObject jsonObj = json.getAsJsonObject();
    ...
    public void onDeviceRpcResponse(MqttPublishMessage mqttMsg) throws adaptor.AdaptorException {
        JsonElement json = JsonMqttAdaptor.validateJsonPayload(sessionId, mqttMsg.payload());
        int msgId = mqttMsg.variableHeader().packetId();
        if (json.isJsonObject()) {
            JsonObject jsonObj = json.getAsJsonObject();
    ...
    public void onDeviceAttributesRequest(MqttPublishMessage msg) throws adaptor.AdaptorException {
    ...
    private String getDeviceName(JsonElement json) throws adaptor.AdaptorException {
        return json.getAsJsonObject().get(DEVICE_PROPERTY).getAsString();
    }

    private String getDeviceType(JsonElement json) throws adaptor.AdaptorException {
        JsonElement type = json.getAsJsonObject().get("type");
        return type == null || type instanceof JsonNull ? DEFAULT_DEVICE_TYPE : type.getAsString();
    }

    private JsonElement getJson(MqttPublishMessage mqttMsg) throws adaptor.AdaptorException {
