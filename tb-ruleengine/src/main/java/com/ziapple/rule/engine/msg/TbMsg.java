...
public final class TbMsg implements Serializable {
    ...
    public static org.thingsboard.server.common.msg.TbMsg fromBytes(ByteBuffer buffer) {
        try {
            ...
            return new org.thingsboard.server.common.msg.TbMsg(UUID.fromString(proto.getId()), proto.getType(), entityId, metaData, dataType, proto.getData(), transactionData, ruleChainId, ruleNodeId, proto.getClusterPartition());
